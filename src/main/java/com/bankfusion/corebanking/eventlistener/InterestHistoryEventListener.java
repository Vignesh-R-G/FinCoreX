package com.bankfusion.corebanking.eventlistener;
...
import com.bankfusion.corebanking.repository.InterestHistoryRepo;
...
public class InterestHistoryEventListener {
    ...
    private void persistInterestHistory(InterestHistoryEvent interestHistoryEvent) {
        ...
        if (eventType.equals(ApiConstants.INT_HISTORY_INITIALIZE_EVENT)) {
            ...
            if(interestHistory == null){
                ...
                BigDecimal openingCreditAccruedInterest = InterestUtils.calculateAccruedInterest(previousInterestHistory.getOpeningBalance(),
                        previousInterestHistory.getOpeningCreditInterestRate(), previousInterestHistory.getOpeningCreditInterest(),
                        previousInterestHistory.getDate(), interestHistoryEvent.getDate());

                BigDecimal openingDebitAccruedInterest = InterestUtils.calculateAccruedInterest(previousInterestHistory.getOpeningBalance(),
                        previousInterestHistory.getOpeningDebitInterestRate(), previousInterestHistory.getOpeningDebitInterest(),
                        previousInterestHistory.getDate(), interestHistoryEvent.getDate());

                initializeInterestHistory(interestHistoryEvent, previousInterestHistory.getOpeningBalance(), openingDebitAccruedInterest,
                        openingCreditAccruedInterest, previousInterestHistory.getOpeningDebitInterestRate(),
                        previousInterestHistory.getOpeningCreditInterestRate());
            } else {
